...
It is built as a homework-style project, not a marketing website. The UI is intentionally simple: one main generator, a result page, login/register pages, and a small dashboard for saved packs.
...
The current frontend uses a minimal warm-glass theme:

- Bright cream background with soft coral and teal accents
- Simple centered generator on the home page
- Minimal copy with no extra landing-page sections
- Loading overlay for generate, login, register, save, and delete actions
